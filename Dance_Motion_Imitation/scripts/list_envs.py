...
All the environments are registered in the `Dance_Motion_Imitation` extension. They start
...
def main():
    """Print all environments registered in `Dance_Motion_Imitation` extension."""
